...
* **Area Forecast:**
    ...
    * [Text file](https://tgftp.nws.noaa.gov/data/raw/fx/fxus66.klox.afd.lox.txt)
* **Coastal Waters Forecast:**
    * [Page](https://forecast.weather.gov/product.php?site=LOX&issuedby=LOX&product=CWF&format=CI&version=1&glossary=0)
    * [Text file](#)
* **Current Buoy Data:**
    * [Page](https://www.ndbc.noaa.gov/station_realtime.php?station=agxc1)
    * [Text file](#)
